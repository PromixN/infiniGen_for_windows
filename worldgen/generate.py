...
os.add_dll_directory("./terrain/lib/cpu/elements")
os.add_dll_directory("./terrain/lib/cuda/elements")
os.add_dll_directory("./terrain/lib/cpu/surfaces")
os.add_dll_directory("./terrain/lib/cuda/surfaces")
os.add_dll_directory("./terrain/lib/cpu/meshing")
os.add_dll_directory("./terrain/lib/cpu/soil_machine")
os.add_dll_directory("./terrain/lib/cpu/utils")
os.add_dll_directory("./terrain/lib/cuda/utils")
import sys
